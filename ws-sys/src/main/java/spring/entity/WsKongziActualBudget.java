...
@Data
@Table(name="WS_KONGZI_ACTUAL_BUDGET")
public class WsKongziActualBudget {
    @Id
    @Column(name = "ID")
    private String id;
    ...
    @ApiModelProperty(value="金额发生差异原因")
    ...
    public WsKongziActualBudget(String id, String createBy, Date createDate, String updateBy, Date updateDate,String status,String serialCode,String title, String type, String target, String content, String address, String nnt, String proThrong, Date startDate, Date endDate, String disburseDetail, BigDecimal disburseAmount, BigDecimal amount, String editReason, String newPro, String newProAmount, String newProReason, String attachId) {
        this.id = id;
